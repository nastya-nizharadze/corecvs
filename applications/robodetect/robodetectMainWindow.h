#ifndef ROBODETECTMAINWINDOW_H
#define ROBODETECTMAINWINDOW_H
...
class RobodetectMainWindow : public QMainWindow
{
    Q_OBJECT

public:
    RobodetectMainWindow(QWidget *parent = 0);
    ~RobodetectMainWindow();
...
private:
    void connectActions();
    Ui::RobodetectMainWindowClass *mUi;

    RobodetectImageWidget *mImageWidget;
