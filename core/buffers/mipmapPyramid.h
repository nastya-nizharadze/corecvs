...
public:
    ...
    AbstractMipmapPyramid(BufferType *input , int _levelNumber, bool check) // JUST TESTING!!!! NASTYA NIZHARADZE
    {
        if (check){
    ...
    static BufferType *downsample21(BufferType *input) // JUST TESTING!!!! NASTYA NIZHARADZE
    {
